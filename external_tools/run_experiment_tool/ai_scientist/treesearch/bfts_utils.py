...
def edit_bfts_config_file(config_path: str, idea_dir: str, idea_path: str, end_stage: int = 4) -> str:
    """
    ...
    # Add end_stage to config for AgentManager access
    config["end_stage"] = end_stage
    print(f"🎯 Config: Added end_stage={end_stage} to configuration")
